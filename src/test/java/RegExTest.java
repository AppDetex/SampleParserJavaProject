...
public class RegExTest {
    ...
    @Test
    public void minecraftIntegrationTest() {
    ...
    @Test
    public void plagueIncIntegrationTest() {
        String response = main.get("https://play.google.com/store/apps/details?id=com.miniclip.plagueinc&hl=en-US");
        Map<String,String> testMap = main.parseStringToMap(response);
        testMap = main.standardizeMapKeys(testMap);
    ...
    @Test
    public void slideyBlockPuzzleIntegrationTest() {
        String response = main.get("https://play.google.com/store/apps/details?id=com.mavis.slidey&hl=en-US");
        Map<String,String> testMap = main.parseStringToMap(response);
        testMap = main.standardizeMapKeys(testMap);
